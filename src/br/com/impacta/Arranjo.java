...
public class Arranjo {
	...
	public Arranjo() {
		...
		// Chama um função para ordenar a Lista inicial e guarda na variavel listOrdenada
		listOrdenada = ordenarLista(LISTA_INICIAL);
		
	}
	/**
	 * Função que retorna o menor valor do arranjo
	 * @return retorna o menor inteiro dentro da lista
	 */
	public int menor() {
	 ...
	 * @return retorna o maior inteiro dentro da lista
	 */
	public int maior() {
	...
	/**
	 * Função que retorna o numero de vezes que um numero 
	 * aparece no arranjo
	...
	public int repeticoes(int numeroRepetido) {
		...
		for(Integer numero : listOrdenada) {
			...
			if(numeroRepetido == numero) repeticoes++;
	...
	// Construtor para caso o usuario queria adicionar uma nova lista para o arranjo que seja diferente da LISTA_INICIAL
